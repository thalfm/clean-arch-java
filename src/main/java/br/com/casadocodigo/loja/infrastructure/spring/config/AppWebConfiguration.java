...
import br.com.casadocodigo.loja.infrastructure.spring.controller.SpringProdutosController;
import br.com.casadocodigo.loja.infrastructure.spring.infra.FileSaver;
import br.com.casadocodigo.loja.infrastructure.spring.resolver.JsonViewResolver;

@EnableWebMvc
@ComponentScan(basePackageClasses = { SpringProdutosController.class, ProdutoRepository.class, ProdutoController.class,
		FileSaver.class, Carrinho.class })
@EnableCaching
